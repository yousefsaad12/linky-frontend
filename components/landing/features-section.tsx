...
const features = [
  {
    ...
    description:
      "Redirects under 20ms at scale — no extra hops, minimal latency.",
    visual: "deploy",
  },
  {
    number: "02",
    ...
    description:
      "Per-link metrics: clicks, geo, device, and referrer data in realtime.",
    visual: "ai",
  },
  {
    number: "03",
    ...
    description:
      "Click metadata is recorded automatically with negligible overhead.",
    visual: "collab",
  },
  {
    number: "04",
    ...
    description:
      "Separate accounts and scoped data for teams and projects.",
    visual: "security",
  },
];
